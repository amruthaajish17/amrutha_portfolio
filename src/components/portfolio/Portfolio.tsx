...
const projects = [
  ...
  },
  {
    ...
    tag: "AI Security",
    desc: "Architected a sandboxed AI gateway using Microsoft Presidio and local LLMs for policy-based logic and regex-driven PII redaction. Conducted rigorous exploratory data analysis (EDA) to precisely model sensitive data leakage probabilities.",
